...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container" style="flex-direction:column">
        ...
        <div style="justify-content: center; align-items: center; background: #79A36F;height: 100px;width: 99.6%;z-index: 0;margin-top: 3px;margin-left: 0.2%;display: flex;align-content: center">
            <h3 style="color: white">Дастовардҳои донишҷӯён</h3>
        </div>
        <!-- Menu -->
        ...
        <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
                <h5 class="card-header">Донишҷӯ: Исобоева Фараҳноз Рустамовна</h5>
                ...
                <div class="card">
                    <div class="table-responsive text-nowrap">
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                <td>1</td>
                                <td><strong>Дипломи дараҷаи 1, Илм - фурӯғи маърифат, даври шаҳрӣ</strong></td>
                                <td><span style="color: #696cff;">file1.png</span></td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td><strong>Дипломи дараҷаи 2, Илм - фурӯғи маърифат, даври вилоятӣ</strong></td>
                                <td><span style="color: #696cff;">file2.png</span></td>
                            </tr>
                            <tr>
                                <td>3</td>
                                <td><strong>Сипоснома, ДПДТТХ</strong></td>
                                <td><span style="color: #696cff;">file3.png</span></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
