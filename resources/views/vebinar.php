...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container" style="flex-direction:column">
        ...
        <div style="justify-content: center; align-items: center; background: #79A36F;height: 100px;width: 99.6%;z-index: 0;margin-top: 3px;margin-left: 0.2%;display: flex;align-content: center">
            <h3 style="color: white">Вебинар</h3>
        </div>
        <!-- Menu -->
        ...
        <div class="content-wrapper">
            <div class="container-xxl flex-grow-1 container-p-y">
                <h5 class="pb-1 mb-4">Ташкили вебинар</h5>
                <div class="row mb-5">
                    <a href = "https://zoom.us/">
                        <div class="col-md">
                            <div class="card mb-3">
                                <div class="row g-0">
                                    <div class="col-md-4">
                                        <img class="card-img card-img-left" src="../assets/img/elements/zoom.png" alt="Zoom" />
                                    </div>
                                    <div class="col-md-8">
                                        <div class="card-body">
                                            <h5 class="card-title">Вебинар бо воситаи Zoom</h5>
                                            <p class="card-text" style="color: #5f6e7f">
                    ...
                    <div class="col-md">
                        <div class="card mb-3">
                            ...
                            <div class="row g-0">
                                <div class="col-md-8">
                                    <div class="card-body">
                                        <h5 class="card-title">Вебинар бо воситаи Jitsi Meet</h5>
                                        <p class="card-text" style="color: #5f6e7f">
                                            Jitsi Meet lets you stay in touch with all your teams. Instant video conferences, efficiently adapting to your scale.
                                            <br>
                                            * Unlimited users
                                        </p>
                                ...
                                <div class="col-md-4">
                                    <img class="card-img card-img-right" src="../assets/img/elements/jitsi.png" alt="Jitsi Meet" />
                                </div>
                            </div>
                            </a>
                        </div>
