...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container" style="flex-direction:column">
        ...
        <div style="justify-content: center; align-items: center; background: #79A36F;height: 100px;width: 99.6%;z-index: 0;margin-top: 3px;margin-left: 0.2%;display: flex;align-content: center">
            <h3 style="color: white">Ташкили ҷамъомад</h3>
        </div>
        <!-- Menu -->
    ...
    <div class="container-xxl flex-grow-1 container-p-y">
        <form action="curator-hour-new.php" method="POST">
            <div class="col-xl-6">
                <!-- HTML5 Inputs -->
                <div class="card mb-4">
                    <h5 class="card-header">Ҷамъомади нав</h5>
                    <div class="card-body">
                        <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            <label for="html5-text-input" class="col-md-2 col-form-label">Номгӯй</label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="Номгӯй" id="html5-text-input" />
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="html5-text-input" class="col-md-2 col-form-label">Макони баргузорӣ</label>
                            <div class="col-md-10">
                                <input class="form-control" type="text" value="Макони баргузорӣ" id="html5-text-input" />
                            </div>
                        </div>
