...
<div class="layout-wrapper layout-content-navbar">
    <div class="layout-container" style="flex-direction:column">
        ...
        <div style="justify-content: center; align-items: center; background: #79A36F;height: 100px;width: 99.6%;z-index: 0;margin-top: 3px;margin-left: 0.2%;display: flex;align-content: center">
            <h3 style="color: white">Ҳисобот оид ба корҳои таълимӣ</h3>
        </div>
        <!-- Menu -->
                    ...
                    <div class="table-responsive text-nowrap">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody class="table-border-bottom-0">
                                <tr>
                                    <td>
                                        <strong>Ҳисоботи нимсолаи 1</strong>
                                        <br>
                                        <a href="" style="color: #696cff; font-size: 12px">file1.pdf</a>
                                    </td>
                                    <td>2022-2023</td>
                                    <td>
                                        <div class="demo-inline-spacing">
                                            <button type="button" class="btn btn-outline-warning">Иваз</button>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <strong>Ҳисоботи нимсолаи 2</strong>
                                    </td>
                                    <td>2022-2023</td>
                                    <td>
                                        <div class="demo-inline-spacing">
                                            <button type="button" class="btn btn-outline-success">Илова</button>
                                        </div>
                                    </td>
                                </tr>
                            </tbody>
